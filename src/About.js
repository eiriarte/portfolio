  ...
  return (
    <section id="about" className="border-bottom p-3">
      <div className="container">
        ...
        <p className={esClass}>Soy un apasionado de las nuevas tecnologías y el software libre. Aunque tengo experiencia en muy diversas tecnologías, soy principalmente
          programador JavaScript: ESNext, Node.js, MEAN stack, AngularJS, React…</p>
        ...
        <p className={enClass}>I'm passionate about high tech and free software. Though I have experience with many diverse technologies, I am, at heart, a
          JavaScript developer: ESNext, Node.js, MEAN stack, AngularJS, React…</p>
